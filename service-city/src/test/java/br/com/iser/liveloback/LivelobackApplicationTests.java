...
// void testGetAll() {
//
// when(cityRepository.findAll()).thenReturn(Fixture.of(City.class).gimme(3,
// TestConstant.CITY_ENTITY));
//
...
// void testAdd() {
//
// City city = Fixture.of(City.class).gimme(TestConstant.CITY_ENTITY);
// when(cityRepository.save(city)).thenReturn(city);
//
// CityDTO cityDTO = Fixture.of(CityDTO.class).gimme(TestConstant.CITY_DTO);
//
...
//
// when(cityRepository.findByStateContaining("RS")).thenReturn(Fixture.of(City.class).gimme(2,
// TestConstant.CITY_ENTITY));
//
...
//
// when(cityRepository.findByStateContaining("RS")).thenReturn(Optional.ofNullable(new
// ArrayList<>()));
//
// MultiValueMap<String, String> fields = new LinkedMultiValueMap<>();
// fields.add("state", "RS");
